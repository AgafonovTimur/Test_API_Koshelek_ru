...
@allure.description("проверка что баланс с точками отображается корректно")
class Test:
    def test_currency_with_dots(self):
        url_2 = "/v1/balances"
        url_currency = "currency=R.U.B."

        response = BUR.url_get(self, url_2, None, url_currency,
                               None, None, None)
